...
if Profile == 1
    ...
    qcno_dB_BigKalm2_w01 = [19:2.5:35 40 45 49]; EBigKalm2_w0 = interp1(SFS.qcno_dB_BigKalm2_w0, SFS.EBigKalm2_w0*360, qcno_dB_BigKalm2_w01, 'cubic');
    ...
    SFS.EKalm2_w0 = SFS.EKalm2_w0 + 0;
    qcno_dB_Kalm2_w01 = [17:2:30 35 50]; EKalm2_w0 = interp1(SFS.qcno_dB_Kalm2_w0, SFS.EKalm2_w0*360, qcno_dB_Kalm2_w01, 'cubic');
    qcno_dB_Kalm2_w0 = 18:0.1:50; EKalm2_w0 = interp1(qcno_dB_Kalm2_w01, EKalm2_w0, qcno_dB_Kalm2_w0, 'cubic');       
    
    qcno_dB_K2PLL1 = [25:0.5:50]; EK2PLL = interp1(SFS.qcno_dB_K2PLL, SFS.EK2PLL*360, qcno_dB_K2PLL1, 'cubic');
    qcno_dB_K2PLL = 25:0.1:50; EK2PLL = interp1(qcno_dB_K2PLL1, EK2PLL, qcno_dB_K2PLL, 'cubic');    
end
