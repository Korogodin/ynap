...
if Profile == 1
    ...
    JS_ArgMax1 = [30:43]; EArgMax = interp1(SFS.JS_ArgMax, SFS.EArgMax*360, JS_ArgMax1, 'cubic');
    JS_ArgMax = 28:0.1:43; EArgMax = interp1(JS_ArgMax1, EArgMax, JS_ArgMax, 'cubic');
    
  
    JS_Mean1 = [30:43]; EMean = interp1(SFS.JS_Mean, SFS.EMean*360, JS_Mean1, 'cubic');
    JS_Mean = 28:0.1:43; EMean = interp1(JS_Mean1, EMean, JS_Mean, 'cubic');

%     SFS.EBigKalm2_w0(1) = SFS.EBigKalm2_w0(1) * 0.8;
    JS_BigKalm2_w01 = [30:43]; EBigKalm2_w0 = interp1(SFS.JS_BigKalm2_w0, SFS.EBigKalm2_w0*360, JS_BigKalm2_w01, 'cubic');
    JS_BigKalm2_w0 = 30:0.1:43; EBigKalm2_w0 = interp1(JS_BigKalm2_w01, EBigKalm2_w0, JS_BigKalm2_w0, 'cubic'); 
    
%     SFS.EKalm2_w0(end-3) = SFS.EKalm2_w0(end-3)*0.85;
    JS_Kalm2_w01 = [28:43]; EKalm2_w0 = interp1(SFS.JS_Kalm2_w0, SFS.EKalm2_w0*360, JS_Kalm2_w01, 'cubic');
    JS_Kalm2_w0 = 28:0.1:43; EKalm2_w0 = interp1(JS_Kalm2_w01, EKalm2_w0, JS_Kalm2_w0, 'cubic');       
    
    JS_K2PLL1 = [28:40]; EK2PLL = interp1(SFS.JS_K2PLL, SFS.EK2PLL*360, JS_K2PLL1, 'cubic');
    JS_K2PLL = 28:0.1:43; EK2PLL = interp1(JS_K2PLL1, EK2PLL, JS_K2PLL, 'cubic');    
end
