...
if Profile == 1
    qcno_dB_ArgMax1 = [10:2:20 23:3:50]; EArgMax = interp1(SFS.qcno_dB_ArgMax, SFS.EArgMax*360, qcno_dB_ArgMax1, 'cubic');
    qcno_dB_ArgMax = 10:0.1:50; EArgMax = interp1(qcno_dB_ArgMax1, EArgMax, qcno_dB_ArgMax, 'cubic');
    
    qcno_dB_Mean1 = [10.3:2:20 23:3:50]; EMean = interp1(SFS.qcno_dB_Mean, SFS.EMean*360, qcno_dB_Mean1, 'cubic');
    qcno_dB_Mean = 10:0.1:50; EMean = interp1(qcno_dB_Mean1, EMean, qcno_dB_Mean, 'cubic');

    qcno_dB_BigKalm21 = [10:1.8:30 35 40 45 49]; EBigKalm2 = interp1(SFS.qcno_dB_BigKalm2, SFS.EBigKalm2*360, qcno_dB_BigKalm21, 'cubic');
    qcno_dB_BigKalm2 = 10:0.1:50; EBigKalm2 = interp1(qcno_dB_BigKalm21, EBigKalm2, qcno_dB_BigKalm2, 'cubic');  
    
    SFS.EBigKalm2_w0 = SFS.EBigKalm2_w0 + 0.0013;
    qcno_dB_BigKalm2_w01 = [10:1.5:30 35 40 45 50]; EBigKalm2_w0 = interp1(SFS.qcno_dB_BigKalm2_w0, SFS.EBigKalm2_w0*360, qcno_dB_BigKalm2_w01, 'cubic');
    qcno_dB_BigKalm2_w0 = 10:0.1:50; EBigKalm2_w0 = interp1(qcno_dB_BigKalm2_w01, EBigKalm2_w0, qcno_dB_BigKalm2_w0, 'cubic'); 
...
%     qcno_dB_Kalm2_w0_corr = 18:0.1:50; EKalm2_w0_corr = interp1(qcno_dB_Kalm2_w0_corr1, EKalm2_w0_corr, qcno_dB_Kalm2_w0_corr, 'cubic');       
    ...
    qcno_dB_Kalm2_w01 = [10:2:20 23:3:50]; EKalm2_w0 = interp1(SFS.qcno_dB_Kalm2_w0, SFS.EKalm2_w0*360, qcno_dB_Kalm2_w01, 'cubic');
    qcno_dB_Kalm2_w0 = 10:0.1:50; EKalm2_w0 = interp1(qcno_dB_Kalm2_w01, EKalm2_w0, qcno_dB_Kalm2_w0, 'cubic');       
    
    qcno_dB_K2PLL1 = [10:1:40 50]; EK2PLL = interp1(SFS.qcno_dB_K2PLL, SFS.EK2PLL*360, qcno_dB_K2PLL1, 'cubic');
    qcno_dB_K2PLL = 10:0.1:50; EK2PLL = interp1(qcno_dB_K2PLL1, EK2PLL, qcno_dB_K2PLL, 'cubic');  
end
